...
public:
  ...
  */
  ...
  bool addShapeFromQueue(MessageQueue& message, Drawings::ShapeType shapeType);
...
private:
  ...
  */
  ...
  friend MessageQueue& operator>>(MessageQueue& stream, DebugDrawing& debugDrawing);
  friend MessageQueue& operator<<(MessageQueue& stream, const DebugDrawing& debugDrawing);
};
