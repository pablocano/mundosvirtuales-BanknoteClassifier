...
bool DebugDrawing::addShapeFromQueue(MessageQueue& message, Drawings::ShapeType shapeType)
{
  ...
  case Drawings::circle:
  {
    ...
    message >> newCircle.x;
    message >> newCircle.y;
    message >> newCircle.radiusX;
    message >> penWidth;
    message >> penStyle;
    message >> newCircle.penColor;
    message >> fillStyle;
    message >> newCircle.fillColor;
  ...
  case Drawings::ellipse:
  {
    ...
    message >> newEllipse.x;
    message >> newEllipse.y;
    message >> newEllipse.radiusX;
    message >> newEllipse.radiusY;
    message >> newEllipse.rotation;
    message >> penWidth;
    message >> penStyle;
    message >> newEllipse.penColor;
    message >> fillStyle;
    message >> newEllipse.fillColor;
  ...
  case Drawings::rectangle:
    {
      ...
      char penWidth, penStyle, fillStyle;
      ColorRGBA penColor, fillColor;
      message >> newRect.topLX;
      message >> newRect.topLY;
      message >> newRect.w;
      message >> newRect.h;
      message >> newRect.rotation;
      message >> penWidth;
      message >> penStyle;
      message >> newRect.penColor;
      message >> fillStyle;
      message >> newRect.fillColor;
  ...
  /*case Drawings::gridRGBA:
  {
    ...
    std::string buffer;
    message >> x >> y >> cellSize >> cellsX >> cellsY >> buffer;
  ...
  /*case Drawings::gridMono:
  {
    ...
    ColorRGBA baseColor;
    std::string buffer;
    message >> x >> y >> cellSize >> cellsX >> cellsY >> baseColor >> buffer;
    const int numberOfCells(cellsX * cellsY);
    InTextMemory stream(buffer.c_str(), buffer.size());
...
MessageQueue& operator>>(MessageQueue& stream, DebugDrawing& debugDrawing)
{
  debugDrawing.reset();
  int size;
...
MessageQueue& operator<<(MessageQueue& stream, const DebugDrawing& debugDrawing)
{
  stream << debugDrawing.typeOfDrawing
         << debugDrawing.timeStamp
         << debugDrawing.firstTip
