 ...
 */
class ConsoleView : public CalibratorTool::Object
{
public:
  /**
   ...
   */
  ConsoleView(const QString& fullName, ConsoleController& console, bool loadAndSaveOutput = false) :
...
private:
  ...
  ConsoleController& console; /**< A reference to the console object. */
 ...
 */
class ConsoleWidget : public QTextEdit, public CalibratorTool::Widget
{
  Q_OBJECT

public:
  ConsoleWidget(ConsoleView& consoleView, ConsoleController& console, QString& output, ConsoleWidget*& consoleWidget);
  ~ConsoleWidget();
