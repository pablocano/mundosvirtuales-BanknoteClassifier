...
public class PositionRegisterCartesian {
	...
	public PositionRegisterCartesian() {
	...
	public ByteBuf getBuffer() {
		...
		byte d = (byte) ((byte) (this.Front ? 0x01 : 0x00) | (byte) (this.Up ? 0x02 : 0x00)
				| (byte) (this.Left ? 0x04 : 0x00) | (byte) (this.Flip ? 0x08 : 0x00));
	...
	public String toString() {
		...
		String ret = "TRAS (" + this.x + ", " + this.y + ", " + this.z + ") ROT (" + this.w + ", " + this.p + ", "
				+ this.r + ") UT:" + this.UT + " UF:" + this.UF;
