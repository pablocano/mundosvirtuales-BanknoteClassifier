...
{
    PacketEthernetIPFanuc read(READ_REG,idPacket,REG_ZONE_GRIP,72);
    PacketEthernetIPFanuc write(WRITE_REG,idPacket,REG_CONTROL_GRIP,theRobotFanucRegisters.robotModel.reg.at(REG_ZONE_GRIP),71);
