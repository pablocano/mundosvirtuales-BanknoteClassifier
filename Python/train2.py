# -*- coding: utf-8 -*-
"""
Created on Tue Oct 03 10:04:24 2017
...
def read_image(img):
    img_ = cv2.resize((cv2.imread(img,1)),(0,0), fx = 0.3, fy = 0.3)
...
def udpateHistogram(hist_array, matches, mask_matches):
    for i in range(len(matches)):
        if mask_matches[i] == 1:
            hist_array[matches[i].queryIdx] += 1
            
    return hist_array


#read image and resize
mil, mil_gray = read_image('../Data/img/mil.jpg')
milB, milB_gray = read_image('../Data/img/milB.jpg')
dosmil, dosmil_gray = read_image('../Data/img/dosmil.jpg')
dosmilB, dosmilB_gray = read_image('../Data/img/dosmilB.jpg')
...
diezmil, diezmil_gray = read_image('../Data/img/diezmil.jpg')
diezmilB, diezmilB_gray = read_image('../Data/img/diezmilB.jpg')
cincomil, cincomil_gray = read_image('../Data/img/cincomil.jpg')
cincomilB, cincomilB_gray = read_image('../Data/img/cincomilB.jpg')
...
gt_name = ['1000_Cara', '1000_Sello', '2000_Cara', '2000_Sello', '20000_Cara', '20000_Sello', '10000_Cara', '10000_Sello', '5000_Cara', '5000_Sello']
...
for name in gt_name:
    ...
    video_capture = cv2.VideoCapture("../Data/vid/" + name + ".mp4")
    ...
    while ret:
        ...
        if kp_query is not None and des_query is not None:
            ...
            M, total_match, mask_matches, current_name = compare(kp_des, kp_query, des_query)
